...
app.use(function (req, res, next) {
  ...
  res.setHeader(
    ...
    "X-Requested-With,content-type,auth-token,cancelToken, responsetype, x-forwarded-for, signature, publickey, message, timestamp, x-api-key, Authorization, address"
  );
  next();
});
...
app.listen(port, () => {
  console.log(`prompt.rip app listening on port ${port}`);
